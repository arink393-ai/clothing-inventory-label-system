...
import { BarChart3, Boxes, ClipboardList, FileClock, HandCoins, LayoutDashboard, PackagePlus, RotateCcw, Settings, ShoppingCart, Users, WalletCards } from "lucide-react";
...
const nav=[
 ...
 ["/shifts","交班盤點",WalletCards,["owner","manager","cashier"]],
 ["/reports","營運報表",BarChart3,["owner","manager"]],
 ["/consignments","寄賣拆帳",HandCoins,["owner","manager"]],
 ["/audit-log","操作紀錄",FileClock,["owner","manager"]],
