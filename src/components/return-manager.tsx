...
export function ReturnManager({ order, recent, query, message, lookupError }: { order?: ReturnOrder; recent: RecentReturn[]; query: string; message?: string; lookupError?: string }) {
